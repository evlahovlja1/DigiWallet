			...
			{props.token ? (
				<Toolbar>
					...
					<Box>
						...
						>
							<MenuItem onClick={gotoTransactions}>Transaction list</MenuItem>
							<MenuItem onClick={gotoPayment}>Payment</MenuItem>
							{props.isAdmin && <MenuItem onClick={gotoClaims}>Claims</MenuItem>}
						</Menu>
					</Box>
					...
					<Box>
						...
						<Menu
							...
							anchorOrigin={{ horizontal: 'right', vertical: 'bottom' }}
						>
							<MenuItem onClick={gotoMyInvoices}>My Invoices</MenuItem>
							<MenuItem onClick={gotoRegisterInv}>Register for E-Invoice</MenuItem>
							{props.isAdmin ? <MenuItem onClick={gotoEinvoiceData}>E-invoice data</MenuItem> : null}
							{props.isAdmin ? <MenuItem onClick={gotoEinvoiceApprove}>E-invoice approval</MenuItem> : null}
						</Menu>
					</Box>
					...
					<Box>
						<Tooltip title='Account' onClick={accountClicked}>
							...
							>
								<Avatar sx={{ width: 32, height: 32, color: 'white', backgroundColor: '#2f2f2f' }}>
